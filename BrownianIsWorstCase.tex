...
&&\E{\R \sim \state(i-1)}{\E{y \sim \adversM(i-1)(\R)}{(y-\ell(i-1))
   \frac{\upperpot(i,\R+2)-\upperpot(i,\R-2)}{2}}}\\
&=&
...
A direct characterization is that $p(X_{t+\deltat}=x_1 |
X_t=x_0)=e^{-\frac{(x_1-x_0)^2}{2 \deltat}}$
...
\section{Conjugate potential functions} \label{sec:self-consistent}
